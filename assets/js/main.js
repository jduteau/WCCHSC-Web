 ...
 function showFridayMeal1(){
  ...
  function partMeals_total1()
  {
      ...
      if(document.getElementById("meals1").style.display=="block"){
        fri_total=parseInt(document.getElementById("fri_b1").value)*12+parseInt(document.getElementById("fri_l1").value)*18+parseInt(document.getElementById("fri_d1").value)*18;
        sat_total=parseInt(document.getElementById("sat_b1").value)*12+parseInt(document.getElementById("sat_l1").value)*18;
