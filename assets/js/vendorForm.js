...
function resetEntry4(){
  ...
  function meals_total1(){
    ...
    if(document.getElementById("meals4").style.display=="block"){
      ...
      fri_total=parseInt(document.getElementById("fri_b4").value)*14+parseInt(document.getElementById("fri_l4").value)*21+parseInt(document.getElementById("fri_d4").value)*22;
      sat_total=parseInt(document.getElementById("sat_b4").value)*14+parseInt(document.getElementById("sat_l4").value)*21;
      temp=basic_total+fri_total+sat_total; 
